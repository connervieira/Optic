...
if ($config["\160\x72\157\x64\165\143\x74\137\156\141\x6d\145"] == "\117\x70\164\151\143\40\x50\x72\x6f") {
    ...
    $video_timestamp = date("Y-m-d His", explode("_", $_GET["video"])[2]); // Generate a human-readable timestamp for the video to copy.
    $destination_name = "./transfers/" . strval($video_timestamp) . "." . $file_extension; // Determine the destination for the video to copy.
