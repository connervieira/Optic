                ...
                if (strtolower(trim(shell_exec("ps -p 1 -o comm="))) !== "systemd") { // Check to see if this system isn't running SystemD.
                    ...
                    if (isset($_GET["action"])) {
                        ...
                        if ($_GET["action"] == "create") {
                            ...
                            shell_exec('sudo systemctl disable predatordashcam.service'); // Disable the Predator dashcam SystemD service.
                            if (file_exists("/etc/systemd/system/predatordashcam.service")) {
                                shell_exec('sudo rm -f /etc/systemd/system/predatordashcam.service'); // Remove the Predator dashcam service file.
